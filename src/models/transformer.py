...
class TransformerModel(pl.LightningModule):
    def __init__(self, input_size, hidden_size, num_layers, output_size, dropout_prob, learning_rate, weight_decay, n_heads, dim_feedforward):
        ...
        # Embedding layer to project input features to the hidden size
        ...
        encoder_layer = nn.TransformerEncoderLayer(
            ...
            dim_feedforward=hidden_size*dim_feedforward,
